...
void SampleUtils::rotatePoseMatrix(float angle, float x, float y, float z, float* matrix){
	if(!matrix){
		return;
	}
...
unsigned int SampleUtils::createProgramFromBuffer(const char* vertexShaderBuffer,
